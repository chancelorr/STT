program shtostt
      ...
      !     by C. Constable, translated to f90 and edited by Chance. 
      !     Most up to date version of shtostt as of 1/9/2021
      !  	reads snaphsot sh field in form of 1,m,glm,hlm and tesselation in form of x,y,z,iflag
      ...
      print *, '            -Program shtostt- '
      print *, 'converts continuous sh model to stt snapshots'
      print *, 'reads tesselation x,y,z,ipp '
      print *, 'with flag ipp for patch integration '
      print *, 'outputs tesselation x,y,z,br, ipp '
      print *, 'for processing by eflux'
      print *, 'models CALS3k.3MAST, ARCH3k.1MAST or SED3k.1MAST'
      print *, 'with our MAST estimation procedure for'
      print *, 'the model coefficients.'
      print *, 'Results are written to a plain text output file.'
      print *, ' '
      print *, 'Choose model: 0 - IGRF 2020'
      ...
      !     flag==0 (IGRF) has some issues with the time varying stuff
      ...
      if (flag.eq.0) then 
            ...
            enddo
                  ...
                  do j=1,nxyz
                        ...
                        npts=npts + 1
                  enddo
                  101	print *, npts, ' read from tessel, ',tessel
                        ...
                        SUBROUTINE BSPLINE(Tknts,T,Nspl,Jorder,Nleft,Spl)
                              ...
                              SUBROUTINE COORDS(H,Theta,R,Sd,Cd)
                                    ...
                                    SUBROUTINE MAGFDZ(P,Dp,Theta,Phi,R,Lmax,G,Dx,Dy,Dz,X,Y,Z,H,F,I,D, &
                                          ...
                                          IMPLICIT NONE
                                          !*--MAGFDZ106
                                          real*8 :: b , bb , Cd , cost , D , dxd , dxk , dxy , dzd , dzk , F ,   &
                                          ...
                                          SUBROUTINE PLMBAR(P,Dp,z,Lmax)
                                                IMPLICIT NONE
                                                !*--PLMBAR209
                                                real*8 :: f1 , f2 , fac , fac1 , fac2 , fden , fnum , plm , pm1 , pm2 ,&
                                                & pmm , sintsq, z
